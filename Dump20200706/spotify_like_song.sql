...
CREATE TABLE `like_song` (
  ...
  KEY `song_idx` (`song`),
  CONSTRAINT `song_like` FOREIGN KEY (`song`) REFERENCES `song` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user_like2` FOREIGN KEY (`user`) REFERENCES `user` (`userName`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-07-06 15:41:02
